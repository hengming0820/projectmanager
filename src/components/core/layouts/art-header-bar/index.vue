  ...
  <div class="layout-top-bar" :class="[tabStyle]" :style="{ width: topBarWidth() }">
    <div class="menu">
      <div class="left" style="display: flex">
        ...
        <ArtLogo class="logo2" @click="toHome" v-if="!isTopMenu" />
      ...
      <div class="right">
        <!-- 搜索 -->
        <div class="search-wrap" v-if="false && shouldShowGlobalSearch">
        ...
        <div
          ...
          v-if="false && shouldShowNotification"
          @click="visibleNotice"
        >
        ...
        <!-- 聊天 -->
        <div class="btn-box chat-btn" v-if="false && shouldShowChat" @click="openChat">
        ...
        <!-- 语言 -->
        <div class="btn-box" v-if="false && shouldShowLanguage">
        ...
        <div class="user">
          ...
          >
            <template #reference>
              <img class="cover" :src="headerAvatar" alt="avatar" />
            </template>
            <template #default>
              <div class="user-menu-box">
                <div class="user-head">
                  <img class="cover" :src="headerAvatar" style="float: left" />
                  <div class="user-wrap">
...
<script setup lang="ts">
  ...
  const userInfo = computed(() => userStore.getUserInfo) // 直接使用计算属性
